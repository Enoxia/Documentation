...
```
We need to visit [Nuclei's Documentation](https://docs.projectdiscovery.io/templates/introduction) for test ideas. We can customize our scan using templates
